...
(function( $, window, document, undefined ) {
	...
	function _fnBrowserDetect( settings )
	{
		...
		if ( ! DataTable.__browser ) {
			...
			// includs the width of the scrollbar, while other browsers ensure the inner
	 ...
	 *  @param {boolean} [bIncludeHidden=false] If true then includs the hidden columns in the calc,
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( scrollX === "" ) {
			...
			// IE7 will make the width of the table when 100% includs the scrollbar
