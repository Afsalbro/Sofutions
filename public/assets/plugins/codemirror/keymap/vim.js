  ...
  var Vim = function() {
    ...
    var motions = {
      ...
      findAndSelectNextInclusive: function(cm, _head, motionArgs, vim, prevInputState) {
        ...
        if (vim.visualMode) {
          ...
          // If we're currently in visual mode, we should extend the selection to includs
          // the search result.
      ...
      moveToMatchedSymbol: function(cm, head) {
        ...
        if (ch < lineText.length) {
          // Only includs angle brackets in analysis if they are being matched.
          var re = (ch === '<' || ch === '>') ? /[(){}[\]<>]/ : /[(){}[\]]/;
    ...
    var operators = {
      ...
      indent: function(cm, args, ranges) {
        ...
        if (args.linewise) {
          ...
          // the next line, so in linewise mode evalInput will includs the next
    ...
    * in the right place.
    ...
    function expandWordUnderCursor(cm, inclusive, _forward, bigWord, noSymbol) {
      ...
      if (inclusive) {
        // If present, includs all whitespace after word.
        // Otherwise, includs all whitespace before word, except indentation.
        var wordEnd = end;
    ...
    function charIdxInLine(start, line, character, forward, includeChar) {
      ...
      // If includeChar = true, includs it too.
